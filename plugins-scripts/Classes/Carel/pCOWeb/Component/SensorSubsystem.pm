...
package Classes::Carel::pCOWeb::Component::SensorSubsystem::Sensor;
use strict;
...
sub finish {
  ...
  if (grep { $self->{unitSensorType} =~ /^$_$/ } @perftypes) {
    bless $self, "Classes::Carel::pCOWeb::Component::SensorSubsystem::Sensor::Perf";
  }
}
...
package Classes::Carel::pCOWeb::Component::SensorSubsystem::Sensor::Perf;
use strict;
our @ISA = qw(Classes::Carel::pCOWeb::Component::SensorSubsystem::Sensor);

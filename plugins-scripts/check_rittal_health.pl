...
my @modes = (
  ...
  ['device::units::list',
      'list-units', undef,
      'Show the units of the cmc ii and update the name cache' ],
  ['device::sensors::list',
      'list-sensors', undef,
      'Show the sensors of the cmc ii and update the name cache' ],
  ['device::devices::list',
      'list-devices', undef,
      'Show the devices of the cmc iii and update the name cache' ],
  ['device::variables::list',
      'list-variables', undef,
      'Show the variables of the cmc iii and update the name cache' ],
  ['device::walk',
      'walk', undef,
